...
export default function App() {
  ...
  const { isAuthenticated, authLoading, login, logout, authError, checkAuthStatus } = useAuth();
      ...
      {isAuthenticated ? (
        <>
          ...
          <div className="text-gray leading-relaxed text-sm">
            활성화 하면 <span className="font-bold text-level5">드래그한 텍스트</span> 또는{" "}
            <span className="font-bold text-level5">이미지</span>가 자동으로 캡처됩니다.
          </div>
